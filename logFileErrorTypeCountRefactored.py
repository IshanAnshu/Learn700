...
def main():
    ...
    machines = ['100.65.137.166','100.65.137.167','100.65.137.168','100.65.137.169','100.65.137.177','100.65.137.178','100.65.137.179','100.65.137.180']
    fileNameString = []
    for ip in machines:
        for fileNumber in range(int(logFilesPerIP)):
            fileNameString.append('{}/{}/aadhar_service.{}.{}.log'.format(date,ip,date,fileNumber))
    result =[]

    global dictErrorCount
    dictErrorCount = {}
    i=0
    totalNumofFiles = len(machines)*int(logFilesPerIP)
